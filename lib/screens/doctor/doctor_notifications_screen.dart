...
/// Doctor-specific notifications screen
...
class _DoctorNotificationsScreenState extends ConsumerState<DoctorNotificationsScreen>
  ...
  List<NotificationModel> _appointmentNotifications = [];
  List<NotificationModel> _paymentNotifications = [];
  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      ...
      // Load all notifications for doctor role
      final allNotifications = await channelService.getRoleBasedNotifications('doctor');
      final unreadNotifications = await channelService.getUnreadRoleBasedNotifications('doctor');
      
      // Filter appointment-related notifications
      final appointmentNotifications = await channelService.getNotificationsByCategory('doctor', 'appointments');
      
      // Filter payment-related notifications
      final paymentNotifications = await channelService.getNotificationsByCategory('doctor', 'payments');
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            ...
            Tab(text: 'Payments (${_paymentNotifications.length})'),
          ],
        ),
      ),
      body: _isLoading
          ...
          : TabBarView(
              ...
              children: [
                ...
                _buildNotificationsList(_paymentNotifications),
              ],
            ),
    );
  }
  ...
  Future<void> _handleNotificationTap(NotificationModel notification) async {
    ...
    switch (notification.type) {
      ...
      case NotificationType.appointmentReminder:
        ...
        break;
      case NotificationType.paymentReceived:
        // Navigate to analytics/earnings screen
        if (mounted) {
  ...
  Future<void> _sendTestNotification() async {
    await RoleBasedNotificationChannelService.instance.sendRoleBasedNotification(
      ...
      title: 'Doctor Test Notification',
      body: 'This is a test notification for doctor panel',
      targetRole: 'doctor',
    );
